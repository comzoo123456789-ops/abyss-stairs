...
(function (global) {
  ...
  var PROPS = {
    P: { id: "portal", sprite: "t_portal", label: "심연의 문",   verb: "들어간다", reach: 1.4 },
    W: { id: "well",   sprite: "t_well",   label: "회복의 샘",   verb: "마신다",   reach: 1.4 },
    M: { id: "shop",   sprite: "merchant", label: "떠돌이 상인", verb: "거래한다", reach: 1.4 },
    K: { id: "stash",  sprite: "p_crate",  label: "창고",        verb: "연다",     reach: 1.4 }
  };
