...
(function (global) {
  ...
  var SKILLS = [
    ...
    /* ── 1차 전직 전용 스킬 (Lv.15 Advanced Skills) ────────── */
    { id: "bloodrage", type: "active", name: "피의 광란", kind: "buff", icon: "s_bloodrage",
      cd: 15.0, cast: 0.0, after: 0.12, stam: 30, dur: 8.0, apsPct: 40, lifesteal: 15,
      text: "8초간 공격속도 +40% 및 생명력 흡수 +15% 부여", syn: [] },
    { id: "leap", type: "active", name: "광폭 도약", kind: "nova", icon: "s_leap",
      cd: 9.0, cast: 0.20, after: 0.20, stam: 32, mult: 2.4, reach: 3.5, push: 1.8,
      text: "공중으로 도약하여 찍으며 핏빛 대지 충격파 폭발", syn: [] },
    { id: "shatter", type: "active", name: "대지 균열", kind: "dash", icon: "s_shatter",
      cd: 8.0, cast: 0.25, after: 0.20, stam: 34, mult: 2.8, dist: 5.0, speed: 24, reach: 1.2,
      text: "전방으로 땅을 가르며 암석 가시 파동 쇄도", syn: [] },
    { id: "decimate", type: "active", name: "분쇄의 일격", kind: "swing", icon: "s_decimate",
      cd: 10.0, cast: 0.35, after: 0.25, stam: 36, mult: 3.5, reach: 2.4, arc: 150, push: 2.0,
      text: "적의 방어력을 무시하는 분쇄의 대검 강타", syn: [] },
    { id: "aegis", type: "active", name: "천상의 결계", kind: "buff", icon: "s_aegis",
      cd: 18.0, cast: 0.0, after: 0.12, stam: 40, dur: 5.0, armor: 50, reflect: 100, heal: 20,
      text: "5초간 신성 보호막 형성 · 무적 및 방어 +50, 피해 반사 100%", syn: [] },
    { id: "judgment", type: "active", name: "신성한 심판", kind: "field", icon: "s_judgment",
      cd: 12.0, cast: 0.30, after: 0.25, stam: 38, mult: 3.2, reach: 2.8, dur: 4.0, tick: 0.5, range: 6.0,
      text: "하늘에서 거대한 신성 성광 기둥 내리꽂기", syn: [] },
    { id: "brand", type: "active", name: "암흑 낙인", kind: "field", icon: "s_brand",
      cd: 11.0, cast: 0.20, after: 0.20, stam: 32, mult: 1.8, reach: 2.5, dur: 5.0, tick: 0.5, range: 5.5, slow: 40,
      text: "적에게 암흑 저주를 걸어 지속 피해 및 40% 둔화", syn: [] },
    { id: "souldrain", type: "active", name: "영혼 흡수", kind: "nova", icon: "s_souldrain",
      cd: 13.0, cast: 0.25, after: 0.20, stam: 36, mult: 2.2, reach: 3.8, heal: 30,
      text: "주위 적들의 영혼을 빨아들여 대미지 및 체력 30% 즉시 회복", syn: [] },
    { id: "stealth", type: "active", name: "그림자 은신", kind: "buff", icon: "s_stealth",
      cd: 14.0, cast: 0.0, after: 0.10, stam: 28, dur: 3.5, critPct: 100, dmgPct: 150,
      text: "3.5초간 그림자 은신 진입, 다음 공격 100% 치명타 및 피해 2.5배", syn: [] },
    { id: "fatalslash", type: "active", name: "치명적 절단", kind: "dash", icon: "s_fatalslash",
      cd: 9.0, cast: 0.10, after: 0.15, stam: 30, mult: 3.6, dist: 5.5, speed: 30, reach: 1.0,
      text: "적 뒤로 순간이동하여 X자 시안 절단 검기 강타", syn: [] },
    { id: "mirrorimage", type: "active", name: "환영분신술", kind: "buff", icon: "s_mirrorimage",
      cd: 16.0, cast: 0.10, after: 0.15, stam: 35, dur: 8.0, apsPct: 50, dmgPct: 30,
      text: "분신 2체를 생성하여 공격속도 +50% 및 환영 연타 수행", syn: [] },
    { id: "shadowdance", type: "active", name: "그림자 난무", kind: "nova", icon: "s_shadowdance",
      cd: 11.0, cast: 0.15, after: 0.25, stam: 38, mult: 4.2, reach: 4.5,
      text: "화면 전체에 시안색 그림자 난무 궤적 8연타 난사", syn: [] },
    { id: "meteor", type: "active", name: "메테오 스트라이크", kind: "field", icon: "s_meteor",
      cd: 14.0, cast: 0.50, after: 0.30, stam: 42, mult: 4.5, reach: 3.6, dur: 5.0, tick: 0.5, range: 7.0,
      text: "하늘에서 화염 룬 마법진과 함께 거대한 메테오 운석 낙하", syn: [] },
    { id: "chainlightning", type: "active", name: "연쇄 전뇌", kind: "nova", icon: "s_chainlightning",
      cd: 8.5, cast: 0.20, after: 0.20, stam: 34, mult: 2.5, reach: 6.0, slow: 50,
      text: "고전압 번개 줄기가 적 5명에게 연쇄로 튕기며 감전", syn: [] },
    { id: "summonundead", type: "active", name: "사령 소환", kind: "buff", icon: "s_summonundead",
      cd: 20.0, cast: 0.30, after: 0.20, stam: 40, dur: 15.0, dmgPct: 40,
      text: "칠흑 소환진에서 언데드 해골 소환수 호출", syn: [] },
    { id: "decayaura", type: "active", name: "부패의 아우라", kind: "field", icon: "s_decayaura",
      cd: 10.0, cast: 0.25, after: 0.20, stam: 30, mult: 0.6, reach: 3.5, dur: 8.0, tick: 0.4, range: 5.0, slow: 35,
      text: "녹보라색 역병 안개가 퍼져 적들의 속도/방어 감소 및 지속 피해", syn: [] }
  ];
